...
import { BalanceHistories, Balances, Currencies, Games, Sessions, SportsBets, Users } from '../models';
...
export const balanceUpdate = async ({
    ...
    const result = await Balances.findOneAndUpdate({ _id: ObjectId(balanceId) }, { $inc: { balance: NumberFix(amount) } }, { new: true });
    const currentBalance = NumberFix(result.balance);
    const beforeBalance = NumberFix(result.balance - amount);
    await BalanceHistories.create({
                ...
                <table style='background-color: #f2f3f8; max-width:670px;  margin:0 auto;' width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
                    ...
                    <tr>
                        <td style='text-align:center;'>
                            <a href='https://wcibets.com' title='logo' target='_blank'>
                                <img width='60' src='https://wcibets.com/logo.png' title='logo' alt='logo'/>
                            </a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td style='text-align:center;'>
                                <p style='font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;'>&copy; <strong>www.wcibets.io</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td style='height:80px;'>&nbsp;</td>
