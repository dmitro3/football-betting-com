...
import { get, getOne, list, create, update, deleteOne, deleteAll } from '../../controllers/brackets/matchs';
...
router.put('/:id', V.params(Validator.ObjectId), V.body(Validator.Brackets.Matchs.Update), update);
