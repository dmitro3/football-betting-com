...
import { create, deleteAll, deleteOne, get, getOne, list, updateOne, updateMany } from '../../controllers/brackets/bets';
...
router.put('/:id', V.params(Validator.ObjectId), V.body(Validator.Brackets.Bets.Update), updateOne);
