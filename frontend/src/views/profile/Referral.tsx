    ...
    return (
        ...
        >
            ...
            <Grid item xs={12} sm={6}>
                <SubCard
                    sx={{ height: '100%' }}
                    title={formatMessage({ id: 'Invite your friends to WCIbets and get 1 extra entry per refferal into lottery pool.' })}
                >
                    ...
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12}>
                            <Typography variant="h4">
                                <FormattedMessage id="Total Entries" />
                            </Typography>
                        </Grid>
                        <Grid item xs={12} style={{ paddingTop: '1rem' }}>
                            <Typography variant="h4">{toNumberTag(referral.rewards, 2)} </Typography>
                            <Divider sx={{ mt: 2 }} />
                        </Grid>
                        {/* <Grid item xs={12}>
                            <Typography variant="h4">
