...
import SingleIcon from '@mui/icons-material/CropPortraitRounded';
import MultiIcon from '@mui/icons-material/ContentCopyRounded';
...
const BetTabs = () => {
    ...
    return (
        <>
            ...
            <Divider sx={{ borderColor: '#979797' }} />
            <Stack my={1} px={1.5} direction="row" justifyContent="flex-end">
                <Button onClick={clearAllHandler} sx={{ color: 'red' }} size="small">
            ...
            {isbet ? (
                <>
                            ...
                            ((item && item.bets) as any[]).map((bet: any, key) => (
                                <Transitions key={key} in direction="left" type="slide">
                                    ...
                                    >
                                        ...
                                        />
                                        <CardContent sx={{ background: '#b5b7bfed', p: 1.5 }} style={{ paddingBottom: '12px' }}>
                    ...
                    <Stack sx={{ background: '#b5b7bfed', p: 2 }}>
                        <Stack direction="row" alignItems="center" justifyContent="center" spacing={2}>
                            <FacebookShareButton url={`${BASE_URL}/bets/${betsId}`} quote="Follow or Fade WCIbets.io">
                                <FacebookIcon size={40} round />
                            </FacebookShareButton>
                            <TwitterShareButton url={`${BASE_URL}/bets/${betsId}`} title="Follow or Fade WCIbets.io">
                                <TwitterIcon size={40} round />
                            </TwitterShareButton>
                            <TelegramShareButton url={`${BASE_URL}/bets/${betsId}`} title="Follow or Fade WCIbets.io">
                    ...
                    <Stack sx={{ background: '#b5b7bfed', p: 2 }}>
                        {activeTab ? (
                            ...
                            <Stack direction="row" justifyContent="space-between">
                                ...
                                <Stack direction="row" alignItems="center" spacing={0.5}>
                                    <Typography className="text-ellipse" variant="body2" color="black" sx={{ maxWidth: '100px' }}>
                                        {toNumber(totalStake)}
                                    </Typography>
                                    <img width="16px" src={currency?.icon} alt="icon" />
                                </Stack>
                        ...
                        <AnimateButton>
                            {isLoggedIn ? (
                                ...
                                <Button
                                    sx={{ mt: 1, bgcolor: '#9a1131', color: 'white' }}
                                    variant="contained"
                                    fullWidth
