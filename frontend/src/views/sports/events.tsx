...
import { checkActive, convertHandicap, formatData, getIsLock } from 'utils/sports';
    ...
    const renderEvent = () => {
        ...
        if (
            ...
            if (bb) {
                return (
                    <>
                        <OddWarraper gridColumn="span 4" update={item?.update1} active={checkActive(betslipData, item.id, OddTypes.Home)}>
                            <Typography className="odd-attr">{home}</Typography>
                            <OddNum odd={aa} />
                        </OddWarraper>
                        <OddWarraper gridColumn="span 4" update={item?.update3} active={checkActive(betslipData, item.id, OddTypes.Draw)}>
                            <Typography className="odd-attr">Draw</Typography>
                            <OddNum odd={bb} />
                        </OddWarraper>
                        <OddWarraper gridColumn="span 4" update={item?.update2} active={checkActive(betslipData, item.id, OddTypes.Away)}>
            ...
            if (!bb) {
                return (
                    <>
                        <OddWarraper gridColumn="span 6" update={item?.update1} active={checkActive(betslipData, item.id, OddTypes.Home)}>
                            <Typography className="odd-attr">{home}</Typography>
                            <OddNum odd={aa} />
                        </OddWarraper>
                        <OddWarraper gridColumn="span 6" update={item?.update2} active={checkActive(betslipData, item.id, OddTypes.Away)}>
                            <Typography className="odd-attr">{away}</Typography>
                            <OddNum odd={cc} />
                        </OddWarraper>
                    </>
            ...
            return (
                <>
                    <OddWarraper gridColumn="span 6" update={item?.update1} active={checkActive(betslipData, item.id, OddTypes.Over)}>
                        <Typography className="odd-attr">Over {bb}</Typography>
                        <OddNum odd={aa} />
                    </OddWarraper>
                    <OddWarraper gridColumn="span 6" update={item?.update2} active={checkActive(betslipData, item.id, OddTypes.Under)}>
