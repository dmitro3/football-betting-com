...
const PagesTerms = () => {
    ...
    const WCIbetsLink = ({ title = 'WCIbets.io' }): any => (
        <Link component={Link} href="https://wcibets.io" target="_blank" underline="none">
            {title}
        </Link>
    );
                    ...
                    <Grid item xs={12}>
                        <MainCard elevation={4} border={false} boxShadow shadow={4} sx={{ mb: 3 }}>
                            <Stack spacing={2} sx={{ textAlign: 'left' }}>
                                <Typography>
                                    In order to place bets with Cryptocurrencies, which includes WCIbets Token, Bitcoins, Ethereum, USDT, or
                                    any Cryptocurrencies we may add in the future, you will first need to open an account on &nbsp;
                                    <WCIbetsLink /> by signing up with an e-mail or connect your MetaMask account. By using &nbsp;
                                    <WCIbetsLink /> (the Website) and clicking on “Join Us” or “Sign In” on <WCIbetsLink />, you are deemed
                                ...
                                <Typography>
                                    ...
                                    (“WCIbets“), and apply to any access or use of the website <WCIbetsLink />. When you complete the
                                    ...
                                    <WCIbetsLink /> services and Website will be treated as your acceptance and consent to be bound by such
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            you are owned by <WCIbetsLink /> or its affiliates and are protected by copyright laws. You may
                                    ...
                                    <li>
                                        <Typography>
                                            You certify that you are not a <WCIbetsLink /> officer, director, employee, consultant, or
                                            agent, or a relative or spouse of any of the foregoing, or that you are not employed by any
                                            company linked with <WCIbetsLink />.
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            this happens, please email support@WCIbets.io to get your account reopened.
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography>
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            valid legally-enforceable debt owed by you to <WCIbetsLink /> in the amount of such wrongfully
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            <WCIbetsLink /> maintains the right, in its sole discretion, to refuse or close a Member Account
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            relevant sport or competition has certified the final result. However, <WCIbetsLink /> has the
                                            ...
                                            party, or <WCIbetsLink /> confirms an irregularity in either betting patterns or event outcome,{' '}
                                            <WCIbetsLink /> has the right to nullify and/or refund any staked amount made on the event at
                                    ...
                                    <li>
                                        <Typography>
                                            If <WCIbetsLink /> discovers that you have placed multiple bets from multiple accounts that you
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            the <WCIbetsLink /> site are all additional information, and <WCIbetsLink /> accepts no
                                    ...
                                    <li>
                                        <Typography>
                                            <WCIbetsLink /> retains the right to enact unique rules, which may be in conflict with the
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            contact WCIbets.io Customer Support).
                                        </Typography>
                                    </li>
                                    <li>
                                        <Typography>
                                    ...
                                    <li>
                                        <Typography>
                                            The maximum stake is determined by the amount accepted by <WCIbetsLink /> at the moment of your
                                            ...
                                            approval until <WCIbetsLink /> has accepted it.
                                        </Typography>
                                    </li>
                                </ul>
                                ...
                                <Typography>
                                    ...
                                    balance or returned to the source. <WCIbetsLink /> shall not be held liable if deposits do not meet our
                                    listed minimum deposit requirements.
                                </Typography>
                                <ul>
                                    <li>
                                        <Typography>WCIbets Token - 15000</Typography>
                                    </li>
                                    <li>
                                ...
                                <Typography>
                                    <WCIbetsLink /> cannot guarantee that all currencies will be natively supported in games and betting
                                    ...
                                    <WCIbetsLink title="[WCIbets.io]" />
                                    &nbsp;
                                    <WCIbetsLink title="(http://WCIbets.io)" />
                                    ...
                                    interest on any outstanding balances, and you acknowledge that <WCIbetsLink /> is not a financial
                                    ...
                                    agree to completely reimburse <WCIbetsLink /> for any overdrawn funds if your account becomes overdrawn
                                    ...
                                    <WCIbetsLink /> has the rights to reject any bets and winnings if we determine, in our sole discretion,
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            deduct such amount from your account. <WCIbetsLink /> will be the sole judge of whether or not a
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            irrespective of the outcome, whether individually or as part of a group, <WCIbetsLink />
                                            &nbsp;reserves the right to reclaim the bonus element of such offers and, in their sole
                                            discretion, <WCIbetsLink /> maintains the right to charge the user an administration fee up to
                                            the amount of the bet. Furthermore, <WCIbetsLink /> maintains the right to charge the user an
                                    ...
                                    <li>
                                        <Typography>
                                            All <WCIbetsLink /> promotions are intended for recreational gamers, and <WCIbetsLink />
                                            reserves the right to limit customer eligibility to participate in all or part of any contest at
                                            any time. <WCIbetsLink /> &nbsp;reserves the right to amend, cancel, reclaim or refuse any
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            found on the relevant content page on this website ([www.WCIbets.io](http://www.wcibets.io/)) or
                                    ...
                                    <li>
                                        <Typography>
                                            ...
                                            Account. <WCIbetsLink /> maintains the right to revoke any bonus and/or bonus program that has
                                ...
                                <Typography variant="h5">
                                    You do so at your own risk when you visit WCIbets.io, placed bets, and play the games. WCIbets.io, bets,
                                    ...
                                    regardless of which Games are played with such funds. WCIbets.io retains the right to declare a wager
                                    ...
                                    unrealized wins as a result of voiding a wager. WCIbets management has complete authority over whether
                                    ...
                                    use of the website or participation in the Games and bets, regardless of cause. WCIbets will not be held
                                ...
                                <Typography>
                                    Any failure or delay in WCIbets.io&apos;s performance of its obligations of service shall not be deemed
                                    a breach of its obligations to you as a customer if such failure or delay is deemed by WCIbets.io to be
                                    ...
                                    lockouts and strikes, delays or disruptions of WCIbets.io is not responsible for any consequences that
                                ...
                                <Typography>
                                    ...
                                    &nbsp;
                                    <Link component={Link} href="mailto:admin@WCIbetstoken.com" underline="none">
                                        admin@WCIbetstoken.com
                                    </Link>
                                    &nbsp;.
                                </Typography>
                            </Stack>
